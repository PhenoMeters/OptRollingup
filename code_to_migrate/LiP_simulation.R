...
simulate_proteins_for_group = function(n_subjects, group_id, n_reps, mask_out, pk_missed_prop, tr_missed_prop, sequences, pk_prob = NULL, tr_prob = NULL){
...
# Immediate:
# potential masking patterns and proportions of each within each group
# lower bound on the peptide length



# Stretch:
# TODO: synthetic label free missingness
